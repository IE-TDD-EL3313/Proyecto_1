...
## ATENCIÓN: btnCpuReset y btnC en la Nexys4 son ACTIVOS EN ALTO (al presionar
## entregan '1'). Nuestro puerto rst_n del diseño es activo en BAJO, así que
## en el top-level de su proyecto debe invertir la señal:
